...
public class CategoryController {
    ...
    public Result getList(@PathVariable Long page, @PathVariable Long limit, CategoryQueryVo categoryQueryVo){
        Page<Category> pageParam = new Page<>(page,limit);
        IPage<Category> pageInfo = categoryService.selectPage(pageParam,categoryQueryVo);
